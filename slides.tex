...
\begin{frame}
   ...
   \begin{itemize}
       ...
       \centerline{\mi{slidefigs/recursion}}%
...
\begin{frame}
   ...
   \begin{itemize}[<+->]
      \item $130\times130$ game has an $X$ point solution
      \item Recursion gives $\Omega(n^{1.52\ldots})$ solution for $n\times n$
      \item We still have no $o(n^2)$ upper bound\ldots
   \end{itemize} 
\end{frame}
