...
\begin{proof}
   ...
   (as in \figref{nested-ears-david}.a) with $x$-coordinate $\x(r)$
   ...
   conditions of \lemref{forbidden}, so that $|S'|\le 2n$.  To see why this is so, suppose that
   $S'$ contains three points $a\in Q_i'$, $b\in Q_j'$, $c\in Q_k'$
   satisfying the conditions of \lemref{forbidden}.  Then the rules for
   ...
   $\nested$) that $Q_j$ is non-decreasing since the leftmost point, $b'$, of $Q_j$ 
