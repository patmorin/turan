...
\begin{proof}
  ...
  Now, for some $Q_i$, consider a point $p$ with $\x(p)=\xmin(Q_i)$ and,
  in case more than one such point exists, take the the one that minimizes
  $\y(p)$.  Now, observe that $\killed(\{\crossing,\swords\},\{p\})
...
Next we focus on the configuration $\swords$ and give linear upper
bounds bounds on $\ex'(n,\{\swords, \taco\})$ and $\ex'(n,\{\swords,
\nested\})$.  For a point $q\in Q$, $\killed(\{\swords\},
\{q\})$ is a fairly large region consisting (roughly) of three
quadrants surrounding $q$ and an additional triangular region:\\
\centerline{\includegraphics[height=3cm]{figs/swords-kappa}} However,
$\killed(\{\swords\}, \{q\})$ has a fairly complicated shape, so much of
the work in this section is devoted to understanding, approximately, how
$\killed(\{\swords\},S)$ evolves as points are added to the point set $S$.
...
\centerline{[height=3cm]{figs/helper-13}}
