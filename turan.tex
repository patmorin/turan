...
\begin{table}
  ...
  New near-optimal results are in dark(er) green. TX denotes Theorem~X in this paper and [X] denotes reference X in this paper. For example T16:[1] denotes a lower bound that appears in Theorem~16 and an upper bound due to Bra\ss\ \cite{brass:turan}.}
