...
\begin{thm}\thmlabel{swords-edgea}
  $\ex(n,\{\swords,\taco\}) \in O(n\log n)$.
\end{thm}
...
\begin{thm}\thmlabel{swords-nested}
  $\ex'(n,\{\swords,\nested\}) \in O(n)$.
\end{thm}
...
\begin{thm}\thmlabel{swords-crossing}
  $\ex'(n,\{\swords,\crossing\}) \in O(n)$.
\end{thm}
