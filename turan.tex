...
Next, we focus on the configuration $\swords$ and give
...
\begin{proof}
  \centerline{\includegraphics[height=3cm]{figs/helper-6}}
...
\begin{proof}
   ...
   $H^{\max}_1,\ldots,H^{\max}_{n-1}$.  The movement of the line
