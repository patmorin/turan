...
\begin{lem}\lemlabel{constant-degree}
  For any three points $a,b,c\in Q$ with no common $x$ or $y$
  coordinates 
  \[ |\survivors(\{\disjointb\},\{a,b,c\})|\in O(1) \]
\end{lem}
...
\begin{proof}[Proof sketch]
  ...
  configuration prevents seecting the same point twice.
\end{proof}
