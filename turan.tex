...
\begin{proof}
  ...
  implies that $Q_i$ is contained in the $\david$-region, $R_i$, of
  the lowest-leftmost point in $Q_i$ FIXME: Not true! There's one extra
  column above.  Indeed, all of $Q_i$ except its leftmost row and column
  is in this $\david$-region.
