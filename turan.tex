...
we assign a mnemonic to each configuration (though the reader is encourage
to choose their own):
...
a single vertex.  These previous results are listed in \tabref{previous}.
...
\begin{proof}
   ...
   for each $i\in\{1,\ldots,n\}$, $Q_i=\{(2i-1,2(i-2): i\in\{1,\ldots,\lfloor n/2\rfloor\}\}$.
\end{proof}
