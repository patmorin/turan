...
\begin{proof}
  ...
  Now, the points the diagonal $y=x-1$ contribute at most $n$ points
  to $S$, so we may assume that none of these points is included in $S$.
  ...
  in a round before $a$ (this is where it is important that $S$ not
  contain points on the diagonal).  Applying \lemref{forbidden} then implies that
  $|S|\le 2n$.
\end{proof}
